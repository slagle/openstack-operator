...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenStackDataPlaneRoleSection) DeepCopyInto(out *OpenStackDataPlaneRoleSection) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpenStackDataPlaneRoleSection.
func (in *OpenStackDataPlaneRoleSection) DeepCopy() *OpenStackDataPlaneRoleSection {
	if in == nil {
		return nil
	}
	out := new(OpenStackDataPlaneRoleSection)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OpenStackDataPlaneSpec) DeepCopyInto(out *OpenStackDataPlaneSpec) {
	*out = *in
	in.DataPlaneNodeRole.DeepCopyInto(&out.DataPlaneNodeRole)
}
